...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "finaldemo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "finaldemo API";

        private String description = "finaldemo API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "finaldemo";
